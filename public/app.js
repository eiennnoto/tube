...
async function renderWatch(id) {
  ...
  try {
    ...
    app.innerHTML = `<section class="watch">
      <div class="player">
        <iframe src="https://classroom.google.com/u/0/n/player?v=${encodeURIComponent(id)}" allow="autoplay; fullscreen" allowfullscreen referrerpolicy="strict-origin-when-cross-origin"></iframe>
      </div>
